...
import { Phone, Globe, ExternalLink, Copy, Check, MapPin, Clock } from "lucide-react"
import * as Tooltip from "@radix-ui/react-tooltip"
import { getPrimaryPhone, getPrimaryWebsite, urlToDisplayLabel } from "@/lib/jurisdictionUtils"
...
export function CourthouseCard({ county }: Props) {
  ...
  const address = county.quickReference?.Courthouse
  ...
  const website = getPrimaryWebsite(county)

  const hasContent = address || phone || hours || website
